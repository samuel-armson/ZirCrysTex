...
for sgi = 1:length(param_list)
	...
	grain_dimension_hist_ellipse(grainsets{1,sgi},'bin_size',5,'max_size',250,'units','nm','max_percentage',20)
end

%%
%Plot Combined 1D histograms
grain_area_hist_multi(grainsets,'bin_size',10000,'units','nm','max_percentage',100,'max_size',400000,'plot_type','hist_line','legend_labels',name_list,'freq','normalised')
