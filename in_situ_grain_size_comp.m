...
for sgi = 1:length(mono_ebsd_list)
  ...
  orientation_deviation_histogram(mono_ebsd_list{1,sgi},'bin_size',1,'max_y',6,'titles',name_list{1,sgi})
  orientation_deviation_histogram_osc(mono_ebsd_list{1,sgi},'bin_size',1,'max_y',6,'titles',name_list{1,sgi})
end
