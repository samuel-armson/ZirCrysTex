...
output_1 = 'D:/Sam/Dropbox (The University of Manchester)/Sam Armson shared folder/Experimental/SPED/2NV selective 2/cs_output'
...
plot_crys_shape(grains_1,[1,4,6,7],'phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2],'output_dir',output_1)
