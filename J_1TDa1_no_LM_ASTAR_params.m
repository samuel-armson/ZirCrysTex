...
grains_mono_b = create_grains(ebsd_mono,'misorientation',12,'smallest_grain',1,'smoothing',0,'fill_gaps','no','assign_filter',0,'phase_name','Monoclinic ZrO$$_2$$')
grains_mono_c = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',1,'smoothing',0,'fill_gaps','no','assign_filter',0,'phase_name','Monoclinic ZrO$$_2$$')
grains_mono_d = create_grains(ebsd_mono,'misorientation',5,'smallest_grain',1,'smoothing',0,'fill_gaps','no','assign_filter',0,'phase_name','Monoclinic ZrO$$_2$$')
grains_mono_e = create_grains(ebsd_mono,'misorientation',3,'smallest_grain',1,'smoothing',0,'fill_gaps','no','assign_filter',0,'phase_name','Monoclinic ZrO$$_2$$')
