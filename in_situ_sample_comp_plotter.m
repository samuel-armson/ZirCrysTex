...
% Mono
data_mono_38NVa1= [pname '38NV_mono_stitched.ctf'];
...
% Metal
data_met_38NVa1= [pname '38NV_full_stitched.ctf'];
...
ebsd_met_LOWDR = dataset_rotation(ebsd_met_LOWDR,[0,20,0],'axis');
ebsd_met_MEDDR = dataset_rotation(ebsd_met_MEDDR,[0,25,0],'axis');
ebsd_met_MEDDR = dataset_rotation(ebsd_met_MEDDR,[0,0,30],'axis');
