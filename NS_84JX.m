...
plot_map(grains_1,'numbered_orientation','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2],'view_unit_cell','CS','gb_overlay',grains_1)
plot_map(grains_2,'numbered_orientation','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2],'view_unit_cell','CS','gb_overlay',grains_2)
