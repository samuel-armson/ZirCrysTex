...
ebsd_3 = loadEBSD(data_3,CS,'interface','ctf','convertSpatial2EulerReferenceFrame');
...
plot_map(ebsd_3,'Euler','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2])


plot_map(ebsd_1,'BC','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2])
plot_map(ebsd_2,'BC','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2])
plot_map(ebsd_3,'BC','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2])


plot_map(grains_1,'gb_only','phase_name','HCP Zr')
plot_map(grains_2,'gb_only','phase_name','HCP Zr')
plot_map(grains_3,'gb_only','phase_name','HCP Zr')
...
output_1 = 'D:/Sam/Dropbox (The University of Manchester)/NanoSIMS data for collab/EBSD/First_try/3_crystal_shapes/'
output_2 = 'D:/Sam/Dropbox (The University of Manchester)/NanoSIMS data for collab/EBSD/First_try/4_crystal_shapes/'
output_3 = 'D:/Sam/Dropbox (The University of Manchester)/NanoSIMS data for collab/EBSD/First_try/5_crystal_shapes/'
...
plot_map(grains_3,'numbered_orientations','phase_name','HCP Zr','crys_sym',ebsd_1('HCP Zr').CS,'ref_text_comp',[0,0,0,2],'view_unit_cell','no','output_dir',output_3)
