...
grains1 = create_grains(ebsd,'misorientation',10,'smallest_grain',1,'smoothing',10,'fill_gaps','yes')
grains2 = create_grains(ebsd,'misorientation',10,'smallest_grain',1,'smoothing',20,'fill_gaps','yes')
grains3 = create_grains(ebsd,'misorientation',10,'smallest_grain',1,'smoothing',30,'fill_gaps','yes')
