...
%%
grain_area_hist_multi(grainsets,'bin_size',200,'units','nm','max_percentage',25,'max_size',25000,'plot_type','hist_line','legend_labels',small_grain_list,'freq','normalised')
