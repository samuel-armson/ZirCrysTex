...
grains_mono_2 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',2,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_3 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',3,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_4 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',4,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_5 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',5,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_6 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',6,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_7 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',7,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_8 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',8,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_9 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',9,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
grains_mono_10 = create_grains(ebsd_mono,'misorientation',10,'smallest_grain',10,'smoothing',1,'fill_gaps','no','phase_name','Monoclinic ZrO$$_2$$')
